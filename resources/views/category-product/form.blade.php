            ...
            <form class="formData">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="name">Nama Kategori Barang</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Kategori Barang" value="{{ $data ? $data->name : '' }}">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function simpan(formData){
        ...
        $.ajax({
            type: "post",
            url: "{{ route('category-product.store') }}",
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
